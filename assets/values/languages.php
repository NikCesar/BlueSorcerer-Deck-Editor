<?php
    ...
    $texts = array(
        ...
        "createUserFail" => array("en" => "Failed to create a new user. Ensure that both username and email are set.", "de" => "Erstellen des Benutzers ist fehlgeschlagen. Stellen Sie sicher, dass Benutzername und Email ausgefüllt sind."),
        ...
        "Email" => array("en" => "Email", "de" => "Email"),
        "Role" => array("en" => "Role", "de" => "Rolle"),
        "CreateUser" => array("en" => "Create new user", "de" => "Neuer Benutzer erstellen"),
        "Login" => array("en" => "Login", "de" => "Login"),
        "Admin" => array("en" => "Admin", "de" => "Admin"),
        "Role_Administrator" => array("en" => "Administrator", "de" => "Administrator"),
